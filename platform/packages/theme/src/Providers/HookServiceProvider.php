...
class HookServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        add_shortcode('media', 'Media - Video', 'Support native video, YouTube, Vimeo, TikTok, X (Twitter)', function (Shortcode $shortcode) {
            $url = $shortcode->url;
        ...
        add_shortcode('audio', 'Audio', 'Support native audio', function (Shortcode $shortcode) {
            $url = $shortcode->url;
